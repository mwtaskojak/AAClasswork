...
describe Dessert do
  let(:chef) { double("chef", name: "kojak") }
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do 
      allow(chef).to receive(:titleize).and_return("Chef kojak the Great Baker")
       expect(brownie.serve).to eq("Chef kojak the Great Baker has made 100 brownies!")
    end  
  end
